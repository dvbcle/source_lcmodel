"""Core compatibility semantic overrides used by the scaffold adapter.

This module keeps legacy routine-name behavior while delegating the main
runtime flow to Python-first pipeline modules."""
